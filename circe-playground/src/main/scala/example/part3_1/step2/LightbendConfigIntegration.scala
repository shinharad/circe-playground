...
// circe-configとrefinedでlightbend configでloadする設定値に制約を持たせる
object LightbendConfigIntegration extends App {
  ...
  val fromConfigDecodedPerson: EitherNec[Throwable, Data] =
    ReadJsonFrom
